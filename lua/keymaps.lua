...
-- Center cursor position when moving up and down    NOTE: Apparently centering the cursor with zz messes up with Mini.Animate, so I will disable this for now
